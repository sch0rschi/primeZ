...
usage: compare.py <pz-report> <pz-total> <ps-report> <ps-total> [<primal-total>]
...
LW, PW, SW, RW, PSW, PRW = 11, 8, 9, 12, 9, 13
GROUP_W = PW + 1 + SW
...
def main() -> int:
    ...
    print(
        ...
        f"{'seconds':>{PSW}} {'primeZ/primal':>{PRW}}"
    )
    print(
    ...
    print(row("discovery", pz_disc, 0.0, pz_total, ps_total))
    ...
    print(row("total", 100.0, 100.0, pz_total, ps_total, primal_total))
